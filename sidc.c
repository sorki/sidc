/*
# sid-collector: A VLF signal monitor for recording sudden ionospheric disturbances
#
# Copyright 2005, Paul Nicholson <sid0807@abelian.org>
...
void alert( char *format, ...)
{
   ...
   sprintf( cmd, "mail -s 'sidc alert' '%s'", CF_mailaddr);
